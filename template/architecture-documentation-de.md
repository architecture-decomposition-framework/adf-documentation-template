...
## Allgemeine Hinweise zur Vorlage <!-- omit in toc -->

Dieses Dokument ist in Markdown geschrieben und lässt sich so ganz einfach mit Texteditoren oder Entwicklungsumgebungen bearbeiten und in eine Versionskontrolle einpflegen (z.B. Git). Wenn wir ein Textverarbeitungsprogramm bevorzugen, können wir die HTML-Ansicht unter Beibehaltung der Überschriftebenen per Copy&Paste dorthin importieren.
